...
class Switchs extends Component {
    constructor(props) {
        ...
        this.state = {
            switchs: [], neww: '',
            id: 5735512002, band: 'GTfarng', model: 'lockerz', price: 5555,
    ...
    editSwitch = (e) => {
        ...
        */
        ...
        axios.put(`${URL}/switchs/${this.state.newId}`, {
    ...
    handleChangenew = (e) => {
        const { neww, value } = e.target
        this.setState({ [neww]: value })
    }
...
<br /><br />
                ...
                <div class="card container">
                    <div class="card-body">
                        ...
                        <form onSubmit={this.addSwitch}>
                            ...
                            <input type="text" name="band" placeholder="Enter Band"
                ...
                <div class="card container">
                    <div class="card-body">
                        ...
                        <br />  <h3>Edit Switch</h3> <br />
                        <form onSubmit={this.editSwitch}>
                            <input type="hidden" name="newid" placeholder="Edit ID"
                                value={this.state.newid}
                                onChange={this.handleChangenew} />&nbsp;
        
                <input type="text" name="newbrand" placeholder="Edit Band"
                                value={this.state.newbrand}
                                onChange={this.handleChangenew} />&nbsp;
        
<input type="text" name="newmodel" placeholder="Edit Model"
                                value={this.state.newbrand}
                                onChange={this.handleChangenew} />&nbsp;
        
<input type="number" name="newprice" placeholder="Edit Price"
                                value={this.state.newbrand}
                                onChange={this.handleChangenew} />&nbsp;
                    <br /><br />
